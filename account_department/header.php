                    ...
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li <?php if ($fileName=="Task.php") echo "id='current'";?>><a href="Task.php">Task</a></li>
                                <li <?php if ($fileName=="Finance.php") echo "id='current'";?>><a href="Finance.php">Finance Reports</a></li>
